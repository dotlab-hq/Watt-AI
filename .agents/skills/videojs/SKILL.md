...
name: videojs
description:  
  This skill provides the ability to integrate Video.js players into your application. It includes documentation and resources for building Video.js players with AI tools.
metadata:
  author: vercel
  version: '1.0.0'
  argument-hint: User asks for integrating a Video player ui
---
